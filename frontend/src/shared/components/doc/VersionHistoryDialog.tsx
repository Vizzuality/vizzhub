...
import type { VersionListItem, VersionDetail } from '@/shared/types/doc';

interface VersionHistoryDialogProps {
  readonly open: boolean;
  readonly onOpenChange: (open: boolean) => void;
  readonly versions: VersionListItem[] | undefined;
  readonly currentVersion: number;
  readonly onRestore: (content: string) => void;
  readonly isRestoring: boolean;
  readonly fetchVersion: (version: number) => VersionDetail | undefined;
}
