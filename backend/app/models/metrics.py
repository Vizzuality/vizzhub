...
class GitHubMetrics(BaseModel):
    ...
    high_severity_vulns: int = Field(default=0, ge=0, description="High/critical vulns open >30 days")
    high_severity_vulns_total: int = Field(default=0, ge=0, description="Total open high/critical vulns")
