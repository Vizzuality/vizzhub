...
router = APIRouter()
router.include_router(insights_router.router, prefix="/insights", tags=["capacity:insights"])
...
router.include_router(allocation_router.router, prefix="/allocation", tags=["capacity:allocation"])
router.include_router(planner_router.router, prefix="/planner", tags=["capacity:planner"])
