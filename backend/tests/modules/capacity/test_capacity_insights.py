...
async def capacity_data(db_session: AsyncSession) -> dict:
    ...
    return {
        "fa_fe": fa_fe,
        "fa_be": fa_be,
        "billable_project": billable_project,
