...
class TestJSONLogging:
    ...
    def test_security_event_includes_timestamp(self) -> None:
        """Events should include timestamp in ISO format."""
        handler = SecurityEventHandler()
        output = StringIO()
    ...
    def test_security_event_includes_event_type(self) -> None:
        """Events should include event_type field."""
        handler = SecurityEventHandler()
        output = StringIO()
        ...
        try:
            ...
            record.event_type = "custom_event_type"
            ...
            assert parsed["event_type"] == "custom_event_type"
