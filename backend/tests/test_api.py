...
class TestCreateProject:
    ...
    async def test_create_project_empty_name_validation_error(self, client: AsyncClient) -> None:
        ...
        response = await client.post(
            "/api/projects",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "", "code": "TST"},
        )
    ...
    async def test_create_project_name_too_long(self, client: AsyncClient) -> None:
        ...
        response = await client.post(
            "/api/projects",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "x" * 256, "code": "TST"},
        )
        assert response.status_code == 400
...
class TestListProjects:
    ...
    async def test_list_projects_returns_all(self, client: AsyncClient) -> None:
        ...
        await client.post(
            "/api/projects",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "Project 1", "code": "Project 1"},
        )
        await client.post(
            "/api/projects",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "Project 2", "code": "Project 2"},
        )
...
class TestReplaceProject:
    ...
    async def test_put_clears_unspecified_optional_fields(self, client: AsyncClient) -> None:
        ...
        response = await client.put(
            f"/api/projects/{project_id}",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "Only Name", "code": "Only Name"},
        )
        assert response.status_code == 200
        data = response.json()
    ...
    async def test_put_project_not_found(self, client: AsyncClient) -> None:
        ...
        response = await client.put(
            f"/api/projects/{fake_uuid}",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "New Name", "code": "New Name"},
        )
        assert response.status_code == 404
    ...
    async def test_put_project_requires_name(self, client: AsyncClient) -> None:
        ...
        create_response = await client.post(
            "/api/projects",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "Test", "code": "Test"},
        )
        project_id = create_response.json()["id"]
...
class TestDeleteProject:
    ...
    async def test_delete_project_success(self, client: AsyncClient) -> None:
        ...
        create_response = await client.post(
            "/api/projects",
            json={"program_id": DEFAULT_PROGRAM_ID, "name": "To Delete", "code": "To Delete"},
        )
        project_id = create_response.json()["id"]
