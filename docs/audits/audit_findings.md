...
- **Frontend (#38):** **closed 2026-05-16** (`5319e868`). #39 chart default-page still open (+ new #40 forecastFinal cap mismatch).
...
- **BurnDashboard `forecastFinal` KPI tile doesn't match the chart endpoint on long-tail projects** — `frontend/src/modules/tracker/components/BurnDashboard.tsx` (`useChartData` + `forecastFinal`).
  - Module: `tracker`
