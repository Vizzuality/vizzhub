...
- **SUSPICIOUS, still open:** ~~#18 CV unimplemented~~ **[fixed `f92ff36b`]**, ~~#20 EAC non-EVM~~ **[fixed `371b031b`]**, ~~#21 ETC implicit~~ **[fixed `371b031b`]**, ~~#24 burn precision divergence~~ **[fixed `c9071f11`]**, ~~#25 base_rate=0~~ **[fixed `c4aaeac9`]**, ~~#26 ECB rate=0 + no historical~~ **[fixed `417aaa4f`]**, ~~#27 invoice MAX(postponed_to)~~ **[fixed `9e8661b9`]**, ~~#28 postponement backdate~~ **[fixed `f084e0de`]**, ~~#30 mood aggregation~~ **[fixed `f63345a8`]**, ~~#31 period rotation idempotency~~ **[fixed `9921bcaf`]**, #33 FA averages partial-reporter drag, #34 user-detail duplicate rows multi-FA, #35 capacity reportable-users 3 leak paths, #36 on-leave too narrow, ~~#38 TS types lying re: Decimal-as-string~~ **[fixed `5319e868`]**, #39 chart default-page. **NEW: #40 forecastFinal vs chart cap mismatch** (logged below — surfaced while fixing #20/#21).
...
- **Frontend (#38):** **closed 2026-05-16** (`5319e868`). #39 chart default-page still open.
